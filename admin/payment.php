        ...
        <table class="table table-bordered" id="table-data">
            ...
            ?>
                <tr>
                    ...
                    <td><?php echo 'Rp ' . number_format($res['roomtotal'], 0, ',', '.') ?></td>
                    <td><?php echo 'Rp ' . number_format($res['bedtotal'], 0, ',', '.') ?></td>
                    <td><?php echo 'Rp ' . number_format($res['mealtotal'], 0, ',', '.') ?></td>
                    <td><?php echo 'Rp ' . number_format($res['finaltotal'], 0, ',', '.') ?></td>
                    <td class="action">
